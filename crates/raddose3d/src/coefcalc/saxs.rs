...
use super::compute::{
    CoefCalcCompute, AVOGADRO_NUM, CARBONS_PER_AMINO_ACID, CARBONS_PER_CARBOHYDRATE,
    CARBONS_PER_DNA_NUCLEOTIDE, CARBONS_PER_RNA_NUCLEOTIDE, HYDROGENS_PER_AMINO_ACID,
    HYDROGENS_PER_CARBOHYDRATE, HYDROGENS_PER_DNA_NUCLEOTIDE, HYDROGENS_PER_RNA_NUCLEOTIDE,
    NITROGENS_PER_AMINO_ACID, NITROGENS_PER_DNA_NUCLEOTIDE, NITROGENS_PER_RNA_NUCLEOTIDE,
    OXYGENS_PER_AMINO_ACID, OXYGENS_PER_CARBOHYDRATE, OXYGENS_PER_DNA_NUCLEOTIDE,
    OXYGENS_PER_RNA_NUCLEOTIDE, PHOSPHORI_PER_DNA_NUCLEOTIDE, PHOSPHORI_PER_RNA_NUCLEOTIDE,
};
use super::CoefCalc;
